      ...
      <div className="space-y-6 max-w-7xl mx-auto overflow-y-auto h-full pb-6">
        ...
        <div className={`flex items-center justify-between transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
          ...
          <button
            onClick={handleSync}
            disabled={syncing}
            className="flex items-center gap-2 px-4 py-2.5 bg-[#1D4ED8] text-white rounded-xl text-[13px] font-medium hover:bg-[#1e40af] hover:shadow-lg hover:shadow-[#1D4ED8]/20 active:scale-[0.98] transition-all disabled:opacity-50 disabled:active:scale-100"
          >
        ...
        <div className={`bg-white rounded-2xl border border-gray-100 overflow-hidden transition-all duration-700 ease-out delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  ...
                  <tr key={lead.id} onClick={() => openLeadPopup(lead)} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/50 transition-colors cursor-pointer group">
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <p className="text-[13px] font-medium text-[#27273D] group-hover:text-[#1D4ED8] transition-colors">{lead.name}</p>
                      </div>
                    </td>
                    <td className="px-5 py-3.5">
          ...
          <div className="px-5 py-3 border-t border-gray-100 flex items-center justify-between">
            ...
            {hasActiveFilters && (
              <span className="text-[12px] text-[#1D4ED8] font-medium">Filtros ativos</span>
            )}
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-3xl shadow-2xl mx-4 max-h-[85vh] overflow-hidden flex flex-col border border-gray-100" onClick={e => e.stopPropagation()}>
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                {leadDetails?.lead?.public_link && (
                  <a href={leadDetails.lead.public_link} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 px-3 py-2 text-[12px] font-medium text-[#1D4ED8] bg-[#1D4ED8]/8 rounded-xl hover:bg-[#1D4ED8]/15 transition-colors">
                        ...
                        <div className="space-y-3">
                          {leadDetails.qualifications.map((q, i) => (
                            <div key={i} className="relative pl-6 pb-3 border-l-2 border-gray-200 last:border-l-0 last:pb-0">
                              <div className="absolute left-[-5px] top-1.5 w-2 h-2 rounded-full bg-[#1D4ED8]" />
            ...
            <div className="px-6 py-4 border-t border-gray-100 flex-shrink-0">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 bg-[#1D4ED8] text-white font-medium rounded-xl hover:bg-[#1e40af] hover:shadow-lg hover:shadow-[#1D4ED8]/20 active:scale-[0.98] transition-all"
              >
