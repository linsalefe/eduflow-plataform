  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        // usa DEFAULT_COLUMNS que já é o estado inicial
      }
      loadLeads();
    };
    init();
              ...
              {columns.map(col => {
                ...
                return (
                  <div key={col.key} className="w-[280px] flex flex-col">
                    {/* Column Header */}
                    <div className="px-4 py-3 rounded-t-2xl border border-b-0" style={{ backgroundColor: `${col.color}18`, borderColor: `${col.color}40` }}>
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[12px] font-bold px-2 py-0.5 rounded-full" style={{ color: col.color, backgroundColor: `${col.color}25` }}>
                          {colLeads.length}
                        </span>
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      style={isDropping ? { boxShadow: `0 0 0 2px ${col.color}`, backgroundColor: `${col.color}08`, borderColor: `${col.color}40` } : { borderColor: '#e5e7eb' }}
