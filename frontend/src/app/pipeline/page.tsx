              ...
              {columns.map(col => {
                ...
                return (
                  <div key={col.key} className="w-[280px] flex flex-col">
                    ...
                    {/* Cards */}
                    <div className={`flex-1 border ${col.border} border-t-0 rounded-b-2xl bg-white/50 p-2.5 space-y-2.5 overflow-y-auto`}>
                      {colLeads.length === 0 ? (
                        ...
                        colLeads.map(lead => (
                          <div
                            ...
                            className="bg-white rounded-xl border border-gray-100 p-3.5 cursor-pointer hover:border-gray-200 hover:shadow-sm transition-all"
                          >
                            {/* Name + Avatar */}
